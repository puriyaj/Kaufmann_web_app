...
export const CLIENT_IP = process.env.NODE_ENV == 'production' ? 'https://kaufmann-web-f4wd1to2c-puriyajs-projects.vercel.app/' : 'http://localhost:3000';
export const API_IP = process.env.NODE_ENV == 'production' ? 'https://api.kaufmann-web-f4wd1to2c-puriyajs-projects.vercel.app/' : 'http://localhost:3000/api';
