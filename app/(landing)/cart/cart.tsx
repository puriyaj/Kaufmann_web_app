...
export const Cart = () => {
  return (
    <div className="flex flex-col md:w-1/2 mx-auto">
      <h2 className="font-bold text-2xl text-center">سبد خرید</h2>
      <div className="flex flex-row-reverse px-8">
        <button className="text-red-600 text-sm font-semibold border-2 rounded-lg px-2 py-1 hover:text-white hover:bg-red-500 border-red-400">حذف تمام آیتم ها</button>
      </div>
      <div className="flex justify-between p-8 shadow">
        <div className="flex gap-4 select-none">
          <Image src={`/image/demo/${rand(1, 21)}.jpg`} alt="" width={100} height={100} />
          <div className="flex flex-col justify-between">
            <h4 className="font-bold text-md">جاروبرقی گازی</h4>
            <span className="text-xs">مشکی</span>
        ...
        <div className="flex flex-col items-end select-none gap-4">
          <span className="font-bold text-sm">200,000</span>
      ...
      <div className="flex flex-col gap-4 rounded-2xl select-none mt-6 px-8 py-4 mx-10 md:mx-20 bg-amber-200">
        <div className="flex justify-between text-black font-semibold">
          ...
          <p className="font-bold">
            710,000 <span className="text-xs font-bold">تومان</span>
          </p>
        </div>
        <button className="text-md text-white bg-orange-500 hover:bg-orange-600 font-semibold rounded-2xl px-2 py-2 ">پرداخت نهایی</button>
      </div>
    </div>
  );
};
