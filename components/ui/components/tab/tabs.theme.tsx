...
export const theme: FlowbiteTabTheme = {
  ...
  tablist: {
    ...
    tabitem: {
      base: "!outline-none flex items-center justify-center py-2 px-4 text-sm font-medium first:ml-0 disabled:cursor-not-allowed disabled:text-gray-400 disabled:dark:text-gray-500",
      styles: {
        default: {
          base: "rounded-t-lg ",
          active: {
