...
export const Spinner: FC<SpinnerProps> = ({ color = "info", light, size = "md", className, ...props }): ReactElement => {
  return (
    <span role="status" {...props}>
      <svg className={classNames(theme.base, theme.color[color], theme.light[light ? "on" : "off"].base, theme.light[light ? "on" : "off"].color[color], theme.size[size], className)} fill="none" viewBox="0 0 100 101">
        <path
