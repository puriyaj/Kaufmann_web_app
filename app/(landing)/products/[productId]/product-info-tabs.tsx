    ...
    <section className="tabs rt-bg rt-overflow rt">
      <div className="tab-btn rt rt-14">
        <span onClick={() => setTab('description')} className={classNames('right rt-400 rt-666 rt-5px rt-pointer', tab == 'description' && 'active')} id="tab-11">
          <i className="fa fa-bars"></i> توضیحات
        </span>
      ...
      {tab == 'description' && (
        <article className="rt rt-444 rt-14 product-content" id="tab-1">
          <h2 className="title rt rt-400 rt-18 rt-relative rt-666">توضیحات</h2>
      ...
      {tab == 'comments' && (
        <div className="rt rt-444 rt-14 product-comments" id="tab-2">
          <h2 className="title rt rt-400 rt-18 rt-relative rt-666">
            {Number(product?.comments?.length ?? 0)} دیدگاه برای {product?.name}
          </h2>
          <div className="side right">
            <div className="notic rt rt-5px">
              <h3 className="name rt rt-17 rt-400 rt-relative">قوانین دیدگاه</h3>
              <ul className="rt rt-666 rt-14">
                <li className="rt rt-400">
                  <i className="fa fa-circle"></i> از ارسال دیدگاه های توهین آمیز پرهیز کنید
                </li>
                <li className="rt rt-400">
                  <i className="fa fa-circle"></i> لطفا نظر واقعی خود را بنویسید
                </li>
                <li className="rt rt-400">
                  <i className="fa fa-circle"></i> دیدگاه شما میتواند به خرید دیگران کمک کند
                </li>
              </ul>
            </div>
            ...
            <form className="rt" onSubmit={handleSubmit(onSubmit)}>
              ...
              <input {...register('name', { required: REQUIRED_MESSAGE })} type="text" className="rt rt-5px rt-14 input rt-400" placeholder="نام*" />
              <input {...register('email')} type="email" className="rt rt-5px rt-14 input rt-400" placeholder="ایمیل*" />
              <textarea
          ...
          <div className="side left rt-5px">
            <h3 className="name rt rt-17 rt-400 rt-relative">لیست دیدگاه ها</h3>
